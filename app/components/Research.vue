    ...
    <UContainer>
      ...
      >
        ...
        >
          ...
          <div
            class="absolute inset-0 flex flex-col items-center justify-center bg-black/45 text-white text-center px-4 transition-opacity duration-300 group-hover:bg-black/60"
          >
            <h3
